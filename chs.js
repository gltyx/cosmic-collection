...
var cnItems = {
    ...
    "Use battle card filters to avoid sacrificing hard to get cards. Protect your most valuable cards!": "使用战斗卡牌过滤器来避免献祭获得卡牌的难度。保护好你最珍贵的卡片！",
    ...
    "Click for next poke to give 10x cards": "下一次点击黑洞，可以得到10倍的卡片",
    ...
    "Empowerment - Increase damage of card behind this card by that percentage": "增强-增加这张卡背后卡片的伤害百分比",
    ...
    "Protection - Chance to protect the card in front of this card, absorbing 50% damage": "保护-有几率保护卡片前面的卡片，吸收50%的伤害",
    ...
    "The achievement itself only needs to be unlocked once, but you can reuse the effect multiple times (even within the same fight once the card’s lockout timer has expired).": "成就本身只需要解锁一次，但你可以多次重复使用这个效果（即使是在同一场战斗中，卡片的锁定计时器已经过期）。",
