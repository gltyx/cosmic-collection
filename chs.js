...
var cnItems = {
    ...
    "Danger Zone": "危险区域",
    "Black Hole pokes and Merchants can now give cards from Sea World realm.": "黑洞点击和商人现在可以提供来自海洋世界领域的卡牌了。",
    "Dark Theme": "深色主题",
    ...
    "Sea World": "海洋世界",
    "Spirit Familiars": "灵宠",
    "These deals are layered like a well-structured deck. And twice as dangerous.": "这些交易是分层的，就像一个结构良好的桥卡牌。而且危险加倍。",
    "Weapons": "武器",
    "/ Poke:": "/ 点击:",
    "Rare Income": "稀有收入",
    "Iron Ore": "铁矿石",
    ...
    "Copper Nugget": "铜块",
    "Shale": "页岩",
    "Every card here has been blessed with good vibes.": "里的每张卡牌都被赋予了良好的氛围。",
    ...
    "Card collectors rejoice: this is your dream spread.": "卡牌收集者欢欣鼓舞：这是你梦想的传播。",
    ...
    "Greetings, deck sorcerer! Every exotic card here perked up at your scent.": "您好，甲板法师！这里的每一张异国卡牌都被你的香味吸引住了。",
    "Greetings, hero of decks! Is that a decent card grin or are you just happy to see me?": "你好，牌组英雄！这是一个良好卡牌笑容，还是你只是很高兴见到我？",
    "Greetings, my glossy friend! Your smile just boosted my rare card drop rate.": "问候，我光鲜的朋友！你的微笑提高了我的稀有卡牌掉落率。",
    ...
    "Have I got a deal for you! A hand-picked stack of cards rarer than moonlight on mythic foil.": "我跟你做个交易！一堆精心挑选的卡牌，比神话箔上的月光还要稀有。",
    ...
    "Hi there, shuffle sovereign! Your collection could start its own religion.": "你好，洗卡牌君主！你的收藏可以形成自己的宗教信仰。",
    "Hi, noble pack whisperer! Even my junk cards tremble before your charisma.": "嗨，高贵的族群语者！在你的魅力面前，我的垃圾卡牌都颤抖了。",
    ...
    "These cards are practically begging to be sleeved by you.": "这些卡牌实际上是求你把它们收起来。",
    "These cards are so fresh, the print ink’s still emotionally attached.": "这些卡牌太新鲜了，上面的墨水还很有感情。",
    "These cards? They tell stories. All heroic. All sparkly.": "这些卡牌吗?他们讲故事。所有的英雄。所有闪闪发光。",
    ...
    "This offer includes cards, charm, AND mild emotional healing.": "这个服务包括卡牌，魅力，和温和的情感治疗。",
    ...
    "What’s better than one epic card? How about five? Or ten? Take your pick!": "还有什么比一张史诗卡牌更好的呢？5点怎么样？还是十?你自己选吧！",
    ...
    "These cards aren’t random. They chose you.": "这些卡牌不是随机的。他们选择了你。",
    ...
    "Decent Cards Are Beneath Me": "良好卡牌是我的身份",
    "Decrease base cooldown for Bugdom by 5s.": "减少昆虫王国的基础冷却时间5秒。",
    "Don’t settle for a single card—grab a full spectrum of rarities while they last!": "不要满足于一张卡牌——在它们还在的时候抓住所有的稀有卡牌！",
    ...
    "Hi there, foil-souled legend! The cards practically stood up when you entered.": "嗨，有箔灵魂的传奇！你进去的时候，卡牌几乎都竖起来了。",
    ...
    "Well met! Your card binder must weigh as much as a dragon's hoard.": "好满足!你的卡牌夹必须和龙的宝藏一样重。",
    ...
    "You like drama? These cards have *lore.* All of them. Even the junk ones.": "你喜欢戏剧？这些卡牌有爱。所有的。即使是垃圾垃圾。",
    ...
    "You’re rarer than a card with working centering.": "你比有工作中心的卡牌还稀有。",
    ...
    "Unlocks a device that intercepts space bending (both passivly and when you flip over cards), which can be activated automate flipping over cards.": "解锁一个拦截空间弯曲的设备（被动和翻转卡牌时），可以激活自动翻转卡牌。",
    ...
    "Fine cards no longer show up after poke (you still get them) unless they gain tier or are new.": "好的卡牌在poke后不再出现（你仍然会得到它们），除非它们获得了等级或者是新的。",
    ...
    "Manual card flips charge interceptor another 2.5x faster.": "手动卡牌翻转收费拦截器又快了2.5倍。",
    ...
    "Battles allow you to unlock cards by defeating them in combat. Each victory permanently unlocks that card for your black hole pokes.": "战斗允许你通过在战斗中击败卡牌来解锁卡牌。每次胜利都会永久地为你的黑洞点击解锁那张卡。",
    ...
    "How do Battles Work?": "战斗是如何运作的？",
    "In battle, cards use their Power × Tier × √Level for Attack, and Defense × √Quantity for HP.": "在战斗中，卡牌使用它们的 力量 × 层级 × √等级 进行攻击，使用 防御 × √数量 对于生命值。",
    "24 hours": "24小时",
    "Place your highest HP card in front to tank damage.": "将你的最高生命值的卡牌放在坦克伤害的前面。",
    ...
    "You can place up to 3 cards in battle slots. The frontmost card takes damage while all cards deal damage.": "你最多可以在战斗槽中放置3张卡牌。当所有的卡牌造成伤害时，最前面的卡牌受到伤害。",
    "Pause Battle": "暂停战斗",
    "Locked for": "锁定",
    "Hide Locked Cards": "隐藏未解锁卡牌",
    ...
    "An all around good guy. Carries 1.5x as many cards (no junk), sells them at 1/2 of the price, and stays 2/3 as long.": "一个全方位的好人。携带1.5倍的卡牌（没有垃圾），以1/2的价格出售，并保留2/3的时间。",
    ...
    "Not a basic bitch. No basic cards. That is all.": "不是一个基本的婊子。没有基本卡牌。就这些。",
    "Orin Saltstride": "奥林·索尔特斯戴德",
    "Petra Moonclasp": "佩特拉·月饼扣",
    "Runa Frostpelt": "鲁娜·弗罗斯特佩尔特",
    "Selene Starwhistle": "瑟琳娜·星笛",
    "Some say he is a real magician, but all know he is rich. He will not even look at cards that are lower rarity than fine.": "有人说他是个真正的魔术师，但大家都知道他很有钱。他甚至不会去看那些稀有度低于精美的卡牌。",
    ...
    "The only BS this guy knows is Bulk Sales. Carries 8x as many cards, sells them at 75% of the price, and stays 1/3 as long.": "这家伙只知道大宗销售。携带8倍的卡牌，以75%的价格出售，保留1/3的时间。",
    ...
    "1 card skipped - due to card being locked": "1卡牌已跳过-由于卡被锁定",
    "Idle Slayer": "放置杀手",
    ...
    "Increase chance that merchants sell multiple copies of cards from 75% to 100%.": "增加商人出售多张卡牌的几率从75%增加到100%。",
    ...
    "So Many Cards, So Few Slots": "这么多卡牌，这么少插槽",
    ...
    "(Sacrifice Time Divider)": "（献祭时间除法器）",
    "Aizen": "蓝染",
    "Arceus": "阿塞俄斯",
    "Bosses": "Boss",
    "Cartman": "卡特曼",
    ...
    "Rocks cards gain Dodge. Spirit Familiars cards gain Absorb.": "石头牌获得躲闪。灵宠卡牌获得吸收效果。",
    ...
    "Advanced Tips": "先进的技巧",
    "After sacrificed card lockout timer expires, the card counts as new. If you have interceptor activated, this can stack lots of automation time.": "献祭的卡牌锁定计时器到期后，该卡牌算作新卡。如果您激活了拦截器，这可能会占用大量的自动化时间。",
    ...
    "Use battle card filters to avoid sacrificing hard to get cards. Protect your most valuable cards!": "使用战斗卡牌过滤器来避免献祭获得卡牌的难度。保护好你最珍贵的卡牌！",
    ...
    "Black Hole pokes can now give cards from Bosses realm.": "黑洞扑克现在可以从boss领域获得卡牌。",
    ...
    "Increase merchant max card bulk offer from 10 * √qty to 100 * √qty.": "将商家最大卡牌批量优惠从10 *√数量增加到100 *√数量。",
    ...
    "Option to see all realms at once in Card Collection. (Why was this not a thing before?)": "在卡牌收集中选择一次查看所有领域。（为什么以前没有这种情况？）",
    "Pokes generate 6.9x worth of pokes of all currencies.": "点击黑洞产生的所有货币点击黑洞价值为6.9倍",
    "Pokes that have Spirit Familiars and Bosses realms selected (other realms can be selected as well) yield 11x cards.": "选择了灵宠和boss领域（游戏邦注：也可以选择其他领域）的黑洞点击会产生11x卡牌。",
    ...
    " - Gain resources equal to this many pokes on each attack (stacks with other cards)": "在每次攻击中获得与此点击黑洞相等的资源（与其他卡一起堆叠）",
    " Chance - Chance to attack again (can proc multiple times)": "几率-再次攻击的几率（可以触发多次）",
    "— these stack permanently and can be farmed by defeating the enemy multiple times.": "-这些可以永久堆叠，并且可以通过多次击败敌人来获得。",
    "Absorber": "吸收器",
    "Absorption Rate: 11(realms) * 0.1 / poke": "吸收速率:11(领域)* 0.1 / 点击黑洞",
    "Battle Tricks & Achievements": "战斗技巧和成就",
    "Be sure to check out": "一定要检查",
    "button to try again.": "按钮重试。",
    "Certain enemies (later on) have": "某些敌人（之后）有",
    "Click for next poke to give 10x cards": "下一次点击黑洞，可以得到10倍的卡牌",
    "Damage Absorption - Reduces damage taken by that percentage": "伤害吸收-减少相应百分比的伤害",
    "Dismember Chance - On Critical Hit, chance to reduce enemy attack by 1% (stacks multiplicatively)": "肢解几率-在暴击时，有1%的几率降低敌人的攻击（叠加）",
    "Dodge Chance - Chance to dodge the enemy attack": "闪避几率-闪避敌人攻击的几率",
    "Empowerment - Increase damage of card behind this card by that percentage": "增强-增加这张卡背后卡牌的伤害百分比",
    "Enemies do not heal between battles, so don't hesitate to launch smaller attacks to chip at their HP.": "敌人不会在战斗之间治愈，所以不要犹豫，发动更小的攻击来消耗他们的HP。",
    "Evolution Chance - On each attack, chance to gain attack equal to half that percentage (stacks multiplicatively)": "进化几率-每次攻击时，获得攻击的几率等于该百分比的一半（堆叠倍增）",
    "Gravitational Wave": "重力波",
    "If you missed unlocking any achievements, you can hit the": "如果你错过解锁任何成就，你可以点击",
    "Kill Rewards": "杀死奖励",
    "on the Achievements tab. It shows which bosses have special achievements.": "在成就选项卡上。它显示了哪些老板有特殊的成就。",
    "Protection - Chance to protect the card in front of this card, absorbing 50% damage": "保护-有几率保护卡牌前面的卡牌，吸收50%的伤害",
    "Special Battle Stats": "特殊战斗属性",
    "Stun Chance - Chance to stun the enemy card, forcing it to miss its next attack (stuns stack)": "晕眩几率-有机会晕眩敌方卡牌，迫使其错过下一次攻击（晕眩堆栈）",
    "The achievement itself only needs to be unlocked once, but you can reuse the effect multiple times (even within the same fight once the card’s lockout timer has expired).": "成就本身只需要解锁一次，但你可以多次重复使用这个效果（即使是在同一场战斗中，卡牌的锁定计时器已经过期）。",
    "These tricks activate when you sacrifice the correct card for the achievement—usually themed around Greek myth lore—and grant a bonus to that encounter.": "当你献祭正确的卡牌获得成就（通常以希腊神话爱情为主题）时，这些技巧就会激活，并为该遭遇战提供加成。",
    "Weak Point Chance - On Critical Hit, chance to deal extra damage equal to 1% of enemy current health": "弱点几率-在暴击时，有几率造成相当于敌人当前生命值1%的额外伤害",
    "When enemy is defeated, all sacrificed cards are removed — so choose carefully.": "当敌人被打败时，所有献祭的卡牌都会被移除——所以要小心选择。",
    "Done": "完成",
...
var cnPrefix = {
    ...
    "Ultimate Sacrifice Time Divider": "终极献祭时间除法器",
