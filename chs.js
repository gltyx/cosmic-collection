...
var cnItems = {
    ...
    "Hide Crappy Rarities": "隐藏蹩脚的稀有物品",
    ...
    "Add 0.404 to merchant rarity scaling.": "增加0.404的商人稀有性缩放。",
    ...
    "Basic cards no longer show up after poke (you still get them) unless they gain tier or are new.": "基本卡牌在戳后不再出现（你仍然会得到它们），除非它们获得了等级或者是新的。",
    "Black Hole pokes and Merchants can now give cards from Greek Gods realm.": "黑洞戳和商人现在可以从希腊神的领域给卡。",
    "Black Hole pokes and Merchants can now give cards from Incremental Games realm.": "黑洞和商人现在可以从增量游戏领域给予卡牌。",
    "Black Hole pokes and Merchants can now give cards from Mythical Beasts realm.": "黑洞戳和商人现在可以从神话兽领域给予卡牌。",
    "Black Hole pokes and Merchants can now give cards from Spirit Familiars realm.": "黑洞戳和商人现在可以从灵宠领域给予卡牌。",
    ...
    "Decent cards no longer show up after poke (you still get them) unless they gain tier or are new.": "体面的卡牌在戳后不再出现（你仍然会得到它们），除非它们获得了等级或者是新的。",
    ...
    "Interceptor also auto-pokes black hole in addition to flipping cards.": "拦截器也自动戳黑洞除了翻转卡。",
    "Locked cards no longer show up after poke.": "锁定的卡不再显示后戳。",
    ...
    "Merchants offers are sorted in reverse by rarity and then realm.": "商人的报价是按稀有性和领域顺序排列的。",
    ...
    "Rare cards no longer show up after poke (you still get them) unless they gain tier or are new.": "稀有卡牌在戳后不再出现（你仍然会得到它们），除非它们获得了等级或者是新的。",
    ...
    "Reduce sacrifice lockout time by 1 hour.": "牺牲锁定时间减少1小时。",
    ...
    "With each poke, harvester gains 1% of the cooldown time.": "每戳一次，收割者获得1%的冷却时间。",
    "Interceptor": "拦截器",
    ...
    "A mouse's teeth never stop growing throughout its entire life.": "老鼠的牙齿在其一生中从未停止生长。",
    ...
    "How about all of them for 10% off?": "全部打九折怎么样？",
    "HP:": "生命值：",
    "Hummingbird": "蜂鸟",
    ...
    "Tethys": "忒堤斯",
    "Sacrifice Card": "牺牲卡片",
    "Sacrificing Cards": "牺牲卡片",
    "Remove all its effects": "移除它的全部效果",
    "All effects from the sacrificed card are removed on sacrifice.": "牺牲卡牌的所有效果在牺牲时被移除。",
    "Ancient sea Titaness and mother of all rivers and nymphs.": "古代海女神，所有河流和仙女之母。",
    "Battle Mechanics": "战斗机制",
    "Battles allow you to unlock cards by defeating them in combat. Each victory permanently unlocks that card for your black hole pokes.": "战斗允许你通过在战斗中击败卡片来解锁卡片。每次胜利都会永久地为你的黑洞戳解锁那张卡。",
    "Check the enemy's stats to plan your strategy.": "检查敌人的属性来计划你的策略。",
    "Consider the lockout timer when choosing cards to sacrifice.": "在选择要牺牲的卡牌时考虑锁定计时器。",
    ...
    "How do Battles Work?": "战斗是如何运作的？",
    "In battle, cards use their Power × Tier × √Level for Attack, and Defense × √Quantity for HP.": "在战斗中，纸牌使用它们的能量×层×√等级进行攻击，使用防御×√数量进行HP。",
    "Lock it for 24 hours": "锁定24小时",
    "Place your highest HP card in front to tank damage.": "将你的最高HP卡片放在坦克伤害的前面。",
    "Reduce Sea World realm odds by 5x.": "减少海洋世界领域的几率5倍。",
    "Reduce Sea World realm odds by another 5x.": "将海洋世界的王国几率再降低5倍。",
    "Sacrificing resets the card's level, tier, and quantity to 0.": "牺牲重置卡牌的等级、层和数量为0。",
    "Sacrificing this card will:": "牺牲这张卡将：",
    "The sacrificed card is locked for 24 hours (can be reduced) after the battle. This prevents you from getting it from pokes and merchants.": "牺牲卡在战斗结束后被锁定24小时（可以减少）。这可以防止你从掮客和商人那里得到它。",
    "To place a card in battle, you must sacrifice it from your collection.": "要将一张牌置于战斗中，你必须从你的收藏中牺牲它。",
